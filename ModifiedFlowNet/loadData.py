...
#     gt_dir = '../data/nuscenes/nuscenes-optical-flow'
#
#     pair = {}
#
...
#
#     # print("we have {} train sample and {} val sample".format(len(train_data), len(val_data)))
#
#     index = {}
...
#
#     train_set = OccNerfDataset(present_train,
#                                next_train,
#                             gt_train)
#
#     test_set = OccNerfDataset(present_val,
#                               next_val,
#                             gt_val)
#     train = {'input_1': present_train, "input_2": next_train, "gt": gt_train}
#     val = {'input_1': present_val, "input_2": next_val, "gt": gt_val}
#
