...
class New_NuscDataset(MonoDataset):
    """Superclass for different types of KITTI dataset loaders
    """
    def __init__(self, *args, **kwargs):
        super(New_NuscDataset, self).__init__(*args, **kwargs)
        ...
        if self.opt.data_type == 'all':
            with open('datasets/nusc/mini_{}.txt'.format(self.split), 'r') as f:
